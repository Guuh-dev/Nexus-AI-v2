...
export const EVOLUTION_OPTIONS: Array<{ value: EvolutionArea; label: string; group: string }> = [
...
export const ACCOUNTABILITY_OPTIONS: Array<{ value: AccountabilityStyle; label: string; description: string }> = [
...
export const CHALLENGE_OPTIONS: Array<{ value: ChallengeMode; label: string; description: string }> = [
