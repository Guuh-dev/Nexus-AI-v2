          ...
          >
            ...
            {!capture ? (
              <>
                ...
                <Card style={[styles.hint, { backgroundColor: `${colors.primary}0D` }]}>
                  <NexusText variant="caption" secondary>
                    O Nexus identifica título, categoria, prioridade, duração, data e XP. Você sempre revisa antes de salvar.
                  </NexusText>
                </Card>
                <View style={styles.actions}>
                  <NexusButton label="Cancelar" variant="ghost" onPress={onClose} style={styles.flex} />
                  {assistantBusy ? (
              ...
              <>
                ...
                <View style={styles.actions}>
                  <NexusButton label="Refazer" variant="ghost" onPress={() => setCapture(null)} style={styles.flex} />
                  <NexusButton label="Salvar captura" onPress={save} style={styles.flex} />
                </View>
              </>
            )}
          </ScrollView>
